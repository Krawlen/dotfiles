...
setup_gitconfig () {
  ...
  then
    ...
    sed -e "s/AUTHORNAME/$git_authorname/g" -e "s/AUTHOREMAIL/$git_authoremail/g" -e "s/GIT_CREDENTIAL_HELPER/$git_credential/g" symlinks/gitconfig-private.example > ~/.gitconfig-private
    success 'gitconfig'
  fi
}
